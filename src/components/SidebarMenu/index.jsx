...
const navigation = [
  ...
  { name: 'Comics', href: 'comics', icon: UsersIcon, current: false },
  { name: 'Characters', href: 'characters', icon: FolderIcon, current: false },
  { name: 'Stories', href: 'stories', icon: CalendarIcon, current: false },
  { name: 'Series', href: 'series', icon: DocumentDuplicateIcon, current: false },
  { name: 'Creators', href: 'creators', icon: ChartPieIcon, current: false },
]
      ...
      */}
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-300 bg-white px-6 py-4">
            <div className="flex h-16 shrink-0 items-center">
              <img
